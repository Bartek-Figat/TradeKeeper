...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/custom-trades/analyze-trade-execution',
            ...(fetchMiddlewares<RequestHandler>(CustomTradeController)),
            ...(fetchMiddlewares<RequestHandler>(CustomTradeController.prototype.analyzeTradeExecution)),

            function CustomTradeController_analyzeTradeExecution(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.analyzeTradeExecution.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/auth/validate-token',
            ...
            function CustomAuthController_validateToken(request: any, response: any, next: any) {
            const args = {
